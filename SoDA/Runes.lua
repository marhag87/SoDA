...
function SoDA:GetRunesGui(character)
    ...
    runesKnown.frame:SetScript("OnHide", function()
        runesKnown.frame:SetScript("OnEnter", nil)
        runesKnown.frame:SetScript("OnLeave", nil)
    end)
    ...
    darkRider.frame:SetScript("OnHide", function()
        darkRider.frame:SetScript("OnEnter", nil)
        darkRider.frame:SetScript("OnLeave", nil)
    end)
